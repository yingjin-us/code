...
/*select org_name from DELTEK.ORG
select * from vw_empl_info*/
create   VIEW dbo.vw_Empl_Info_All
AS
SELECT     dbo.DELTEK_EMPL.EMPL_ID, dbo.DELTEK_EMPL.LAST_NAME, dbo.DELTEK_EMPL.FIRST_NAME, dbo.DELTEK_EMPL_LAB_INFO.ORG_ID, 
                      ...
                      dbo.DELTEK_EMPL_LAB_INFO.ANNL_AMT,
						--dbo.DELTEK_EMPL_LAB_INFO.SAL_GRADE_CD, 
		      			--MB 03/12/2007 SAL_GRADE_CD NEED TO FETCH FROM LOCAL TABLE
                          (SELECT     TOP 1 Grade
                      ...
                      dbo.IDMaster.IDMaster_DOT AS TERM_DT, i.Directory_Title, e.EMPL_CLASS_CD, o.ORG_NAME,
                          (SELECT     TOP 1 Grade_Step
                            ...
                            WHERE      (Empl_ID = dbo.crs_tblempl_info.Empl_ID)
                            ORDER BY Effect_DT DESC) AS grade_step, dbo.crs_tblempl_info.Perf_Review -- vamsi - added perf_review col.
