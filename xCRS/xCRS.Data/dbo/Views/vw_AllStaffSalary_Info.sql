/*AND (dbo.vw_R_IDMaster_Info_SU_DOPE_CRS_Empl_Info.SU4 <> 'BRD')*/
CREATE VIEW dbo.vw_AllStaffSalary_Info
AS
SELECT     dbo.DELTEK_EMPL.EMPL_ID, dbo.DELTEK_EMPL.LAST_NAME, dbo.DELTEK_EMPL.FIRST_NAME, dbo.DELTEK_EMPL_LAB_INFO.ORG_ID, 
                      ...
                      dbo.crs_tblempl_info.Perf_Review, dbo.DELTEK_EMPL_LAB_INFO.ANNL_AMT,
                          (SELECT     TOP 1 Grade
                      ...
                      dbo.IDMaster.IDMaster_DOT AS TERM_DT, i.Directory_Title, e.EMPL_CLASS_CD, o.ORG_NAME,
                          (SELECT     TOP 1 Grade_Step
                            ...
                            WHERE      (Empl_ID = dbo.crs_tblempl_info.Empl_ID)
                            ORDER BY Effect_DT DESC) AS grade_step, dbo.crs_tblempl_info.Grade_Category, dbo.IDMaster.Title_Code
FROM         dbo.crs_tblempl_info INNER JOIN
                      ...
                      dbo.DELTEK_EMPL_LAB_INFO AS e ON dbo.crs_tblempl_info.Empl_ID = e.EMPL_ID AND e.END_DT = '31-dec-2078'
      ...
      Begin Tables = 
         ...
         Begin Table = "i"
            Begin Extent = 
               Top = 486
               Left = 38
               Bottom = 601', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vw_AllStaffSalary_Info';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'Right = 327
   ...
   Begin CriteriaPane = 
      ...
      End
   End
End', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vw_AllStaffSalary_Info';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'vw_AllStaffSalary_Info';
