CREATE VIEW dbo.vw_Unselected_Empl_List_Downloaded_Reviewed
AS
SELECT     dbo.vw_Empl_Info.EMPL_ID, dbo.vw_Empl_Info.LAST_NAME, dbo.vw_Empl_Info.FIRST_NAME, dbo.vw_Empl_Info.ORG_ID, 
                      ...
                      dbo.vw_Empl_Info.SU4, dbo.vw_Empl_Info.SU4_Name, dbo.CRS_tblSal_Info_Downloaded.Effect_DT, 
                      dbo.CRS_tblSal_Info_Downloaded.Supervisor_Empl_ID, dbo.vw_Empl_Info.TERM_DT
...
WHERE     (dbo.vw_Empl_Info.ACTIVE = 1) AND (dbo.CRS_tblSal_Info_Downloaded.Reviewed = 1) AND (dbo.vw_Empl_Info.TERM_DT IS NULL)
