CREATE                           VIEW dbo.vw_Empl_Info_ACT
AS
SELECT     dbo.DELTEK_EMPL.EMPL_ID, dbo.DELTEK_EMPL.LAST_NAME, dbo.DELTEK_EMPL.FIRST_NAME, dbo.DELTEK_EMPL_LAB_INFO.ORG_ID, 
		      ...
		      dbo.CRS_tblEmpl_Info.TobeReviewed, fldReviewProcess, CRS_tblEmpl_Info.CompReviewType,
		      ...
		      --MB 03/12/2007 SAL_GRADE_CD NEED TO FETCH FROM LOCAL TABLE
	              (select top 1 grade from crs_tblsal_info
			where empl_id=dbo.CRS_tblEmpl_Info.Empl_ID order by effect_dt desc) SAL_GRADE_CD,
...
WHERE     (dbo.DELTEK_EMPL_LAB_INFO.END_DT > CONVERT(DATETIME, '2078-12-30 00:00:00', 102)) AND 
			...
			and CRS_tblEmpl_Info.Active=1 AND TERM_DT is null 
