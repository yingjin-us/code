CREATE VIEW dbo.vw_Unselected_Empl_List_Downloaded
AS
...
WHERE     (dbo.vw_Empl_Info.ACTIVE = 1) AND (dbo.CRS_tblSal_Info_Downloaded.Reviewed = 0) AND (dbo.vw_Empl_Info.TERM_DT IS NULL)
