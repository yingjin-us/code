create         procedure usp_admingetBonus_for_CY
...
if @ReviewCYearforBonus =''
	SELECT     SUM(dbo.CRS_tblBon_Info_Downloaded.Bon_Amt) AS AMOUNT, dbo.CRS_lkpBonus_Type.Bon_Type, CRS_tmpReport.SU1, CRS_tmpReport.SU2, 
                      CRS_tmpReport.SU3, CRS_tmpReport.SU4, CRS_tmpReport.ORG, CRS_tmpReport.User_ID, crs_tmpreport.cur_sal, crs_tmpreport.cur_grade,
	...
	GROUP BY dbo.CRS_lkpBonus_Type.Bon_Type, CRS_tmpReport.SU1, CRS_tmpReport.SU2, CRS_tmpReport.SU3, CRS_tmpReport.SU4, CRS_tmpReport.ORG, 
                      CRS_tmpReport.User_ID, dbo.CRS_tblBon_Info_Downloaded.Bon_Amt, CRS_tmpReport.RCol4, crs_tmpreport.cur_sal, crs_tmpreport.cur_grade,
			crs_tblprojteam.proj_id
