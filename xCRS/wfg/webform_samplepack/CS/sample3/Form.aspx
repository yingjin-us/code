<%@ Page ValidateRequest="False" Language="C#" AutoEventWireup="true"  CodeFile="Form.aspx.cs" Inherits="Form" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>Timesheet sample</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <TABLE runat="server" id="TABLE1" class="Form-table" cellSpacing="1" cellPadding="1" width="98%" align="center">
            <TR>
                <TD valign="top" align="right" class="Form-table-cell-label" style="height: 159px">
